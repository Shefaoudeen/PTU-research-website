...
const Footer = () => {
  return (
    <>
      <div className="bg-[#1e6c93] h-[25vh] sm:h-[30vh] text-white p-5 flex items-center justify-center text-center">
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-medium text-lg sm:text-2xl">Maintained by</h1>
          <div className="flex flex-col items-center justify-center text-lg sm:text-2xl mt-6">
