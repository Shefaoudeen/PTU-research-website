...
const Banner = (props) => {
  return (
    <>
      <div
        className="h-[40vh] bg-no-repeat bg-cover"
      ...
      >
        <div className="flex items-center justify-between h-full  py-5 px-12">
          ...
          <div className=" flex flex-col items-center gap-4 text-4xl px-10">
            <h1 className="text-blue-300 font-semibold">{props.title}</h1>
            <h1 className={`text-wrap text-2xl text-white ${props.desc_style}`}>
              {props.desc}
            </h1>
